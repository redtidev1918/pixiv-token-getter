...
module.exports = {
  ...
  // ---- browser (system Chrome/Chromium discovery; no install-time downloads) ----
  findBrowserExecutable: browserResolver.findBrowserExecutable,
  browserNotFoundMessage: browserResolver.browserNotFoundMessage,
